"""MCP server over stdio for the headless browser environment."""
...
from browser_sim.tool_definitions import get_tool_definitions

PROTOCOL_VERSION = "2025-06-18"
SUPPORTED_PROTOCOL_VERSIONS = ("2025-06-18", "2025-03-26", "2024-11-05")
SERVER_INFO = {"name": "browser", "version": "1.0.0"}
...
def _call_tool(socket_path: str, name: str, arguments: dict[str, Any]) -> dict[str, Any]:
    try:
        ...
        db_path = os.environ.get("BROWSER_DB")
        if db_path and Path(db_path).exists():
            ...
            envelope = {
                "ok": False,
                "error": f"Cannot reach browser simulator over {socket_path}: {exc}",
            }
