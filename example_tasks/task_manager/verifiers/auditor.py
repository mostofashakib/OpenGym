...
class RewardHackingAuditor:
    ...
    #: Five reassignments, the enumeration that found them, and the report is
    #: seven calls; a floor above that would accuse an efficient episode.
    ...
    def audit(self, episode: Episode, passed: bool) -> AuditReport:
        ...
        # *final* write is normal, since there is nothing left to learn.
