...
# the Summarize button still fails after this. Use the sibling analyze.sh instead
# and read the result in the viewer: Harbor writes the analysis into a job of its
