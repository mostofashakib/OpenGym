...
This repository includes one release reconciliation scenario as a concrete fixture and
...
The bundled scenario contract lives in `verifiers/contracts/release_reconciliation.py` and
