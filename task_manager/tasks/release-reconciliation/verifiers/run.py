...
Needs `task_sim` on the path for the answer key: run with
`PYTHONPATH=environment:.` from a checkout, or `/opt/grading:/opt` in the graded
container.
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--contract",
        default="release_reconciliation",
