...
from task_sim.service import DEFAULT_DB_PATH, DEFAULT_SNAPSHOT_PATH, SCENARIOS
...
def main() -> None:
    ...
    scenario = SCENARIOS.get(args.scenario, RELEASE_RECONCILIATION_SCENARIO)
    environment = TaskHandoverEnvironment(args.db, args.snapshot, scenario=scenario)
    result: Any
