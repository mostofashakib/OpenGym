...
from verifiers.contracts.release_reconciliation import MILESTONE_EVENTS, build_contract
...
def test_exact_state_reports_what_it_saw() -> None:
    ...
    verifier = ExactStateVerifier(expectations=(
        StateExpectation("right", lambda e: e.assignee("TASK042"), "U008"),
        StateExpectation("wrong", lambda e: e.assignee("TASK042"), "U005"),
    ...
    check("and reports the actual value", outcomes["wrong"].detail["actual"] == "U008")
...
def test_a_vacuous_ordering_is_not_a_pass() -> None:
    ...
    verifier = TemporalVerifier(orderings=(Ordering("release_audit_inspected", "circular_dep_broken"),))
...
def test_ordering_catches_an_answer_given_too_early() -> None:
    early = (
        ...
        ("submit_handover_report", {"task_ids": ["TASK035"], "summary": "done"}),
