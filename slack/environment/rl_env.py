#!/usr/bin/env python3
"""JSON CLI for the SlackIncidentEnvironment RL contract."""
...
from slack_sim.environment import DEFAULT_MAX_TURNS, SlackIncidentEnvironment
...
def main() -> None:
    ...
    parser.add_argument("--prompt-id", default="slack_operator")
    ...
    environment = SlackIncidentEnvironment(args.db, args.snapshot)
    result: Any
